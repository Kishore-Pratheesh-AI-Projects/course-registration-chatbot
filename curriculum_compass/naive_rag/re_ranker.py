# 70% of storage used … If you run out, you can't create, edit, and upload files.
from transformers import AutoModelForSequenceClassification, AutoTokenizer
import torch
 
class Reranker:
    def __init__(self, reranker_model_name="cross-encoder/ms-marco-MiniLM-L-12-v2", device="cuda"):
        """
